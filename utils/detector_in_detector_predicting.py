...
from luminoth.utils.image_vis import draw_object_prediction
...
class PredictorNetwork(object):
    ...
    def __init__(self, config):
        ...
        with graph.as_default():
            ...
            if hasattr(model, "partial_reduce_pred_list"):
                ...
                pred_dict = model.partial_reduce_pred_list(pred_dict)[0]
            ...
            #if not hasattr(model, "partial_reduce_pred_list"):
            if True:
    ...
    def predict_image(self, image):
        ...
        pred_dict = {"classification_prediction":dict()}
        pred_dict["classification_prediction"]["objects"] = fetched["objects"]
        pred_dict["classification_prediction"]["labels"] = fetched["labels"]
        pred_dict["classification_prediction"]["probs"] = fetched["probs"]
        img_pil = draw_object_prediction(pred_dict, image)
        img_pil.show()
