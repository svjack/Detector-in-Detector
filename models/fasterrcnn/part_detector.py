...
from luminoth.models.fasterrcnn.part_detector_rcnn import RCNN
...
class FasterRCNN(snt.AbstractModule):
    ...
    def _build(self, conv_feature_map, Head_hf_part_conv, image, gt_boxes=None, is_training=False):
        """
        ...
        return valid_conclusion(gt_boxes)
